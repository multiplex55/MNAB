...
pub struct AppState {
    ...
    pub search: String,
    pub search_id: Id,
    pub register_columns: crate::app::settings::RegisterColumns,
    pub display_density: crate::app::settings::DisplayDensity,
...
impl Default for AppState {
    fn default() -> Self {
        ...
        Self {
            ...
            search: String::new(),
            search_id: Id::new("register-search"),
            register_columns: Default::default(),
            display_density: Default::default(),
